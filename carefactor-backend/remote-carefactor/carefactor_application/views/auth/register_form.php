...
<table>
	...
	<tr>
        ...
        <tr>
		<td><?php echo form_label('User Type', $usertype['id']); ?></td>
		<td><?php echo form_input($usertype); ?></td>
		<td style="color: red;"><?php echo form_error($usertype['name']); ?><?php echo isset($errors[$usertype['name']])?$errors[$usertype['name']]:''; ?></td>
	</tr>
	<tr>
