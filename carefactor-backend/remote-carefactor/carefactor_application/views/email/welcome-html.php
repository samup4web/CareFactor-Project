            ...
            <table width="80%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="left" width="95%" style="font: 13px/18px Arial, Helvetica, sans-serif;">
                        ...
                        <br />
                        <big style="font: 16px/18px Arial, Helvetica, sans-serif;"><b><a href="<?php $this->load->helper('url'); echo site_url('/auth/login/'); ?>" style="color: #3366cc;">Go to <?php echo $site_name; ?> now!</a></b></big><br />
                        <br />
